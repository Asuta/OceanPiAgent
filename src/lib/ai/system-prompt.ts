...
export function buildRoomBridgePrompt(options?: RoomBridgePromptOptions): string {
  const roomBridgeInstruction = [
    ...
    "The safe room-only tools are send_message_to_room, read_no_reply, list_attached_rooms, list_known_agents, create_room, add_agents_to_room, leave_room, remove_room_participant, get_room_history, memory_search, memory_get, workspace_list, workspace_read, workspace_write, workspace_delete, workspace_append, workspace_move, and workspace_mkdir.",
