...
export function buildSystemPrompt(userPrompt?: string): string {
  const basePrompt = [
    ...
    "The available tools are web_fetch and custom_command, and room runs may also expose memory tools plus dedicated per-agent workspace tools.",
